function createUnityInstance(e, t, r) {
    ...
    if (
      (t &&
        ...
        (r +=
          "\n" +
          t.stack
            .substring(t.stack.lastIndexOf(r, 0) ? 0 : r.length)
            .replace(/(^\n*|\n*$)/g, "")),
  ...
  function a(e, t, r) {
    ...
    if (
      !(
        (l.errorHandler && l.errorHandler(e, t, r)) ||
    ...
    return new Promise(function (t, r) {
      ...
      n.open("GET", l[e]),
        ...
        n.addEventListener("load", function (r) {
          s(e, r), t(new Uint8Array(n.response));
        }),
        n.send();
    });
  }
    ...
    return new Promise(function (e, t) {
      ...
      (r.src = l.frameworkUrl),
        (r.onload = function () {
          ...
          (unityFramework = null), (r.onload = null), e(t);
        }),
        ...
        ? l.SystemInfo.hasWasm
          ? (1 == l.SystemInfo.hasWebGL &&
            ...
            l.postRun.push(function () {
              r(1), delete l.startupErrorHandler, e(p);
            }),
            u())
